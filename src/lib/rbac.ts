...
export const RBAC_POLICY: RBACPolicy = {
  super_admin: {
    ...
    customers: { scope: 'ALL', actions: ['view', 'create', 'update', 'delete', 'export', 'manage_tickets'] },
    automation: { scope: 'ALL', actions: ['view', 'create', 'update', 'delete', 'test'] },
  ...
  finance: {
    ...
    customers: { scope: 'ALL', actions: ['view', 'export'] },
  ...
  sales_rep: {
    ...
    automation: { scope: 'SELF', actions: ['view'] },
