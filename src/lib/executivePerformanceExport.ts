...
export function exportExecutivePerformanceXlsx(data: ExecutivePerformanceResponse) {
  ...
  const summaryRows = [
    ...
    { Metric: "Pending proposals", Value: s.proposalsPending },
    { Metric: "Won proposals", Value: s.proposalsWon },
    { Metric: "Revenue without GST", Value: s.revenueExclGst },
    { Metric: "Proposals approved", Value: s.proposalsApproved },
    { Metric: "Proposals rejected", Value: s.proposalsRejected },
    { Metric: "Deals", Value: s.dealsCreated },
